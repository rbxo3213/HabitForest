        ...
        <ThemeProvider>
          <div className="flex flex-col min-h-screen relative overflow-x-hidden">
            ...
            <header className="hidden md:flex items-center justify-between p-6 bg-white shadow-sm z-50">
              <div className="font-bold text-xl tracking-tight">해빗 빌리지</div>
              <nav className="flex gap-6 font-medium">
                <a href="/dashboard" className="hover:text-black text-gray-600 transition-colors">홈</a>
                <a href="/timer" className="hover:text-black text-gray-600 transition-colors">타이머</a>
                <a href="/village/user1" className="hover:text-black text-gray-600 transition-colors">내 마을</a>
              </nav>
            </header>
